    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Add Language</h4>
                    ...
                    <form action="{{ route('admin.languages.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="language_name" name="language_name" placeholder="Enter language Name" required="">
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="language_file">language_file</label>
                                <input type="file" class="form-control" id="language_file" name="language_file" placeholder="chouse file" required="">
                            </div>
                        </div>
